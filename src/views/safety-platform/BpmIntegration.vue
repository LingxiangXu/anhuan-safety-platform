  ...
  <div class="bpm-integration">
    ...
    <div class="section-card">
      <div class="section-head">
        <h3 class="section-title">?? 对接架构总览</h3>
    ...
    <div class="section-card">
      <div class="section-head">
        <h3 class="section-title">? 对接实施流程</h3>
  ...
  data() {
    return {
      ...
      bpmStats: [
        ...
        { icon: '??', label: '平均审批时长', value: '4.6h', sub: '较线下缩短68%', grad: 'linear-gradient(135deg, #D97706, #FBBF24)', color: '#D97706' }
      ],
      sourceModules: [
        { icon: '?', name: '特殊作业管控' },
        { icon: '??', name: '隐患治理督办' },
