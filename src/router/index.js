...
import EmergencyHelp from '@/views/safety-platform/EmergencyHelp.vue';
...
import Value from '@/views/safety-platform/Value.vue';
...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'emergency-help', name: 'EmergencyHelp', component: EmergencyHelp },
      ...
      { path: 'value', name: 'SafetyValue', component: Value },
